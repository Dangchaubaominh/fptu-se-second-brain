    ...
    return ListView(children: [
      ...
      section('Vault', [
        ...
        Wrap(spacing: 8, runSpacing: 8, children: [
          OutlinedButton.icon(onPressed: () => pickVault(ref), icon: const Icon(Icons.folder_open), label: const Text('Đổi vault')),
          OutlinedButton.icon(
      ...
      section('Trợ lý AI (Claude)', [
        Text('Model: ${ClaudeClient.model}. Lấy API key tại console.anthropic.com. '
        ...
        Row(children: [
          ...
          if (_testing) const Padding(padding: EdgeInsets.only(left: 12), child: SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 2))),
        ]),
