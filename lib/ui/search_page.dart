...
class _SearchPageState extends ConsumerState<SearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      const PageHeader(title: 'Tìm kiếm', subtitle: 'Tìm không dấu vẫn ra ("con tro" → "Con trỏ"). Gõ #tag để lọc theo tag. Phím tắt: Ctrl+K'),
      Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: query.isEmpty
                ? null
                : IconButton(icon: const Icon(Icons.clear), onPressed: () => ref.read(searchQueryProvider.notifier).set('')),
          ),
        ),
      ),
      Padding(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(h.note.path, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.outline)),
